// src/lib.rs
/*
 * Core library for PreviewEngine
 */
...
#[derive(Debug)]
pub struct PreviewEngineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PreviewEngineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PreviewEngine processing");
    
    let mut processor = PreviewEngineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PreviewEngineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PreviewEngineProcessor::new(false);
